...
export default function AboutPage() {
  ...
  return (
    <>
      <Helmet
        title={`${site.siteMetadata.title} -  Website development services`}
      />
      <Content>
        ...
        <ul>
          <li>
            ...
            <OutboundLink href="https://verifiable.com">
              Verifiable
            </OutboundLink>
          ...
          <li>
            I’m passionate about quality. In my work I stick to web standarts
            and best practices, focusing on accessibility and performance. I use
            auditing tools like{' '}
        ...
        <ol>
          <li>
            ...
            <a href={`mailto: ${email}`}>{email}</a>, or via any other service
            of your choice mentioned on the{' '}
            <Link to="/programming">programming</Link> page. Further
            communication can be done via messengers (Telegram, Slack, etc.).
          </li>
          <li>
            I provide feedback and estimation based on requirements and designs
            that you give me. If you don’t have designs yet – no problem, I have
            a person who can help with designs.
          </li>
          <li>
            ...
            <OutboundLink href="https://www.upwork.com">Upwork</OutboundLink>.
            In this case contract agreement is not needed, but the platform will
            take it’s fee (10-20%).
          </li>
          <li>
          ...
          <li>
            Optionally, but I highly recommend to configure automatic updates
            for framework and plugins. Site will redeploy automatically when
            dependencies update. Usually this improves performance and fixes
            bugs. It’s important to keep dependencies and code up-to-date if you
            plan to scale website and introduce new features later. Similar like
            you keep your smartphone up-to-date, it helps to secure it and
            allows to use latest apps. Note: in case if there are major
            framework updates (usually once a year), they need to be applied
            manually by developer accordingly to upgrade docs. I typically reach
            out to client by myself later if there are major updates available
